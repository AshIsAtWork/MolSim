...
We are entering the contest with the result after our first optimization step. This is the commit 603ca5be. To run our program use the following command: 
