...
protected:
    ...
    void compareResults(Particle& res, std::array<double, 3> &pos,
        ...
        //Because our data for comparison is in 3 digits accurate, we use 1e-03 as tolerance.
...
TEST_F(SimulatorTest, SolarSystem) {
    Gravity gravity;
    std::string filepath = "../input/eingabe-sonne.txt";
    Simulator simulator(filepath, gravity, 1, 0.1);
