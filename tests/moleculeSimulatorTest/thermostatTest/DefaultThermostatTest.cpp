...
/**
 * Compare calculated kinetic energy against hand calculated value.
 */
TEST_F(DefaultThermostatTest, calculateKineticEnergy_BasicTest) {
...
/**
 * Compare calculated temperature against hand calculated value.
 */
TEST_F(DefaultThermostatTest, calculateTemperature_BasicTest) {
    DefaultThermostat thermostat{dS, 10, 10, 10, 3};
...
/**
 * The temperature of a system with no particles is undefined.
 */
TEST_F(DefaultThermostatTest, calculateTemperature_UndefinedTemperature) {
    DefaultThermostat thermostat{dS, 10, 10, 10, 3};
    EXPECT_THROW(thermostat.calculateTemperature(), std::exception);
}

/**
 * Check, if the temperature initialisation sets the system to a temperature close to the initialisation temperature.
 */
TEST_F(DefaultThermostatTest, initialiseSystem_BasicTest) {
 ...
 */
TEST_F(DefaultThermostatTest, setTemperatureOfTheSystemViaVelocityScaling_BasisTest) {
 ...
 */
TEST_F(DefaultThermostatTest, setTemperatureOfTheSystemViaGradualVelocityScaling_BasicTest) {
...
/**
 * Test cooling of a system that is applied gradually from 10 to 1 in 9 steps.
 */
TEST_F(DefaultThermostatTest, cooling) {
...
/**
 * Test heating of a system that is applied gradually from 1 to 100 in 99 steps.
 */
TEST_F(DefaultThermostatTest, heating) {
...
/**
 * Holding the system on a temperature of 100. Temperature is manipulated by Brownian Motion.
 */
TEST_F(DefaultThermostatTest, holdingATemperature) {
