...
TEST(XMLReaderTest, Basic_LinkedCells_Cuboid_XMLTest) {
    ...
    std::string filename = "../tests/testData/XMLReader.xml";
    ASSERT_EQ(XMLReader::readFile(originalFile, simulationSettings), 0);
    ...
    EXPECT_EQ(simulationSettings.parametersLinkedCells.rCutOff, 0);
    ...
    EXPECT_EQ(simulationSettings.parametersLinkedCells.boundarySettings[1].first, enumsStructs::Side::back);
    EXPECT_EQ(simulationSettings.parametersLinkedCells.boundarySettings[1].second, enumsStructs::BoundaryCondition::reflective);
    EXPECT_EQ(simulationSettings.parametersLinkedCells.boundarySettings[2].first, enumsStructs::Side::left);
    EXPECT_EQ(simulationSettings.parametersLinkedCells.boundarySettings[2].second, enumsStructs::BoundaryCondition::reflective);
    EXPECT_EQ(simulationSettings.parametersLinkedCells.boundarySettings[3].first, enumsStructs::Side::right);
    ...
    EXPECT_EQ(simulationSettings.cuboids[0].dimensions[0], 0.0);
    EXPECT_EQ(simulationSettings.cuboids[0].dimensions[1], 0.0);
    EXPECT_EQ(simulationSettings.cuboids[0].dimensions[2], 0.0);

    EXPECT_EQ(simulationSettings.cuboids[0].h, 1.1225);
    EXPECT_EQ(simulationSettings.cuboids[0].mass, 1.0);

    EXPECT_EQ(simulationSettings.cuboids[0].initVelocity[0], 100);
    EXPECT_EQ(simulationSettings.cuboids[0].initVelocity[1], 20);
    EXPECT_EQ(simulationSettings.cuboids[0].initVelocity[2], 1);
    ...
    EXPECT_EQ(simulationSettings.cuboids[1].dimensions[0], 0.0);
    EXPECT_EQ(simulationSettings.cuboids[1].dimensions[1], -10.0);
    EXPECT_EQ(simulationSettings.cuboids[1].dimensions[2], 0.0);

    EXPECT_EQ(simulationSettings.cuboids[1].h, 1.1225);
    EXPECT_EQ(simulationSettings.cuboids[1].mass, 1.0);

    EXPECT_EQ(simulationSettings.cuboids[1].initVelocity[0], 20);
    EXPECT_EQ(simulationSettings.cuboids[1].initVelocity[1], 20);
    EXPECT_EQ(simulationSettings.cuboids[1].initVelocity[2], 1);
